...
namespace NewWorkManager.BLL
{
    public class DingTalkClientBLL
    {
        ...
        private NewOrderEntities db = new NewOrderEntities();
        ...
        public long SendMessage(string AccessToken, long AgentId, string UserList, string Content, string MessageUrl)
        {
            string DingID = db.UsersDing.Where(a => a.UserCD == UserList).FirstOrDefault().DingID;
